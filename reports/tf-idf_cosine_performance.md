...
- **Recall@3**: 0.7200
- **MRR**: 0.9867
- **Runtime (in seconds)**: 7.4088
- **Peak Memory (in KB)**: 916.9150
...
3. ✅ `conceptual` | Score: `0.0000` - The Revised Penal Code penalizes various forms of fraudulent activities that cause financial harm....
...
3. ✅ `conceptual` | Score: `0.0000` - Legal frameworks have evolved to address technological developments and their implications for crimi...
...
3. ✅ `conceptual` | Score: `0.0000` - Economic regulations foster competitive business environments that benefit consumers and the economy...
...
3. ❌ `irrelevant` | Score: `-0.0000` - Monetary policies control inflation and stabilize currency value....
...
3. ✅ `paraphrase` | Score: `0.0000` - The Philippine government is generally protected from lawsuits unless it expressly allows itself to...
...
3. ✅ `conceptual` | Score: `0.0000` - Electoral laws establish frameworks for democratic processes and peaceful transfer of power....
...
3. ❌ `irrelevant` | Score: `0.0000` - The Land Transportation Office registers motor vehicles and issues driver's licenses....
...
3. ❌ `irrelevant` | Score: `0.0000` - Businesses must register with appropriate government agencies....
...
3. ❌ `irrelevant` | Score: `0.0000` - The state has the power to regulate taxes and public spending....
...
3. ❌ `irrelevant` | Score: `0.0000` - The Office of the Ombudsman investigates complaints against public officials....
...
3. ❌ `irrelevant` | Score: `0.0000` - The Department of Tourism promotes the country’s tourist destinations....
...
3. ✅ `conceptual` | Score: `-0.0000` - Local governments have mechanisms to resolve minor conflicts within their jurisdiction....
...
3. ✅ `conceptual` | Score: `0.0000` - Constitutional rights protect property owners from unjust land seizures....
...
3. ✅ `conceptual` | Score: `0.0000` - Public health and safety laws address substance abuse through both punitive and rehabilitative appro...
